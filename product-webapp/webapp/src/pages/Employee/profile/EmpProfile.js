...
export default function EmpProfile() {
    ...
    const getUserDetails = async(id) =>{
      ...
      const requestOptions = {
        ...
        fetch(URL.SET+`job/byEmployeeId/${id}`, requestOptions)
        .then((res) => {
    ...
    const update = async(e) =>{
      ...
      const requestOptions = {
        ...
        fetch(URL.SET+`job/update/employee`, requestOptions)
        .then((res) => {
                ...
                <div className="d-flex align-items-center">
                  <div>
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-4">
                        <span className="h4 d-block mb-0">{activeUser} <h6 className='text-muted mt-1' style={{fontStyle:'italic'}}>({role})</h6></span>
                      </div>
                    </div>
                  </div>
            ...
            <form className="mb-6">
              <div className="row mb-5">
                <div className="col-md-6">
                  <div className="">
                    <label className="form-label" for="user_id">{role} Id</label>
                    <input type="text" disabled className="form-control" id="user_id" value={activeUserId}/>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="">
                    <label className="form-label" for="name">{role} Name</label>
              ...
              <div className="row g-5">
                <div className="col-md-6">
                  <div className="">
                    <label className="form-label" for="email">{role} Email</label>
                ...
                <div className="col-md-6">
                  <div className="">
                    <label className="form-label" for="contact">{role} Contact No</label>
               ...
               <div className="col-md-6">
                ...
                <div className="col-12">
                  <div className="">
                    <label className="form-label" for="address">{role} Address</label>
